...
public class CustomerServiceImpl implements CustomerService {
	...
	public Customer updateCarDetails(String phoneNumber, String plateNumber, CarDetails carDetails)
		...
		for(Customer c : list) {
			if(c.getPhoneNumber().equals(phoneNumber)) {
				deleteCarDetails(phoneNumber, plateNumber);
				return addCarDetails(phoneNumber, carDetails);
			}
		}
		throw new InvalidDetailsException("Customer does not exist. Check the customer phone number.");
	}
	...
	@Override
	public Customer addCarDetails(String phoneNumber, CarDetails carDetails) throws InvalidDetailsException{
...
//		Customer cus = customerRepository.findById(phoneNumber).orElseThrow(()-> new InvalidDetailsException("invalid phone"));
	...
	public Customer viewCustomer(String phoneNumber) {
		Customer cus = customerRepository.findById(phoneNumber).
