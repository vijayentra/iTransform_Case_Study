    ...
    function LoginCustomer() {
        ...
        const submit=()=>{
            axios.get("http://localhost:8088/customer/loginCustomer/"+phoneNo+"/"+password).then((response)=>{
                ...
                <section class="text-gray-600 body-font relative">
                    <div class="container px-5 py-24 mx-auto">
                        <div class="flex flex-col text-center w-full mb-12">
                            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Customer Login</h1>
                        </div>
