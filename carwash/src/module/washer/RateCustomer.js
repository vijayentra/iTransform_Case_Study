...
function RateCustomer() {
    ...
    const handleRateWasher = () => {
        ...
        axios.put("http://localhost:8082/booking/washComplete/" + bookingId, payload).then((response) => {
            ...
            <section class="text-gray-600 body-font">
                <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        ...
                        <p class="mb-8 leading-relaxed">Your feedback matters! Rate the customer's behavior to ensure a great experience for all. </p>
                        <div class="flex w-full md:justify-start justify-center items-end">
                            ...
                            <button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" onClick={()=>handleRateWasher()}>Finish</button>
                            <button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" onClick={() => handleRateLater()}>Later</button>
                            </div>
                        </div>
                    </div>
